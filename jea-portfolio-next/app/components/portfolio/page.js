    ...
    return(
        <section className="section-work section container-dark" id="work">
            ...
            <div id="portfolio" className="portfolio">
                <div id="btnFilter">
                    <button className="btn active" > Tout</button>
                    <button className="btn">
                        Photographies</button>
                    <button className="btn" >Sites web</button>
                </div>

                <div className="container">
                    <div className="filter pictures">
                        <img src="https://jean-portfolio-six.vercel.app/assets/images/skooter%20Marrakech.jpg" alt="img" />
